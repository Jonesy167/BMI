...
# set file paths
healthy = os.path.dirname(os.path.abspath("__file__")) +  "\data\healthy.jpg"
superfat = os.path.dirname(os.path.abspath("__file__")) + "\data\superfat.jpg"
superfat2 = os.path.dirname(os.path.abspath("__file__")) + "\data\superfat2.jpg"
superfat3 = os.path.dirname(os.path.abspath("__file__")) +"\data\superfat3.jpg"
...
sex = (raw_input("are you male or female? enter M for Male and F for female  - sorry if you idenfity as anything else (not sorry) this program doesn't take into account people who idenfity as non-binary, trees, cats or any other weird stuff                                                                         "                                                     ))
